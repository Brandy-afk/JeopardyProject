...
*
* This function uses the inOrder member function of the
...
void	printHTMLpages(BinTree<Question>& questionSet, int categoryID)
{
	questionSet.inOrder(printHTMLpage, categoryID);
}
...
void	printHTMLpage(Question item, int categoryID, int& questionID)
{
	char		fileName[24];
	std::ofstream	htmlPage;
	std::string		title;

	sprintf(fileName, "game/cat%d_%d00.htm", categoryID, questionID);
